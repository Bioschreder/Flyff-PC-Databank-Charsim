...
#define IK3_TALISMAN						254		// 부적

#define IK3_SMELT_TALISMAN_MATERIAL			255		// 부적 강화 재료

#define	IK3_BARUNA_TWOWEAPONCOMBINE_MATERIAL			256 // 바루나 양손무기합성 재료
#define IK3_BARUNA_TWOWEAPONCOMBINE_PROTECTION		257	// 바루나 양손무기합성 캐시아이템 (보호)
#define IK3_BARUNA_TWOWEAPONCOMBINE_RATE				258 // 바루나 양손무기합성 확률 증가

#define IK3_NOPARTY_EXP_RATE						259	// 솔플일때 경험치 추가 아이템
#define IK3_PARTY_EXP_RATE						260	// 파티일때 경험치 추가 아이템

#define IK3_TALISMAN_SLOT						261		// 부적 슬롯 사용 스크롤

#define	IK3_PIERCING_ULTIMATE_MATERIAL			262 // 얼터밋 피어싱 재료
#define	IK3_PIERCING_ULTIMATE_MATERIAL_PREMIUM			263 // 고급 얼터밋 피어싱 재료
//#define IK3_PIERCE_ULTIMATE_PROTECTION					264	// 얼터밋 피어싱 보호 아이템
#define IK3_PIERCE_ULTIMATE_GEN_MAT_CANCEL				264	// 얼터밋 보석 취소 두루마리

#define MAX_ITEM_KIND3			266		// ItemKind3 총 개수
